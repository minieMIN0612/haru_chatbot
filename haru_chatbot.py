...
if st.session_state.emotion_stage == "ask_emotion":
    emotion_input = st.text_input("👩🏻 지금 기분이 어때? (예: 기쁨, 슬픔, 짜증, 불안 등)", key="emotion_input")
    ...
    st.write(f"👩🏻 왜 '{st.session_state.emotion}' 같은 기분이 드는 것 같아?")
